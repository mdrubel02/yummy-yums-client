...
const Chef = ({chef}) => {
    ...
    return (
        ...
        <div className="text-[17px] space-y-1 capitalize">
            <p><span className='font-semibold'>Location :</span> {num_of_recipes}</p>
            <p><span className='font-semibold'>Years Of Purchase :</span> {years_of_experience}</p>
            <p className='mt-2 font-semibold'>Resale Price <span className='text-red-600 font-semibold text-2xl'>${likes}</span></p>
