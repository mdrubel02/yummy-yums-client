                ...
                <div style={{ 'backgroundImage': 'linear-gradient(90deg, #0201010d 40%, #BBCED5 80%)' }}>
                    <div className="card-body">
                        <div className="card-actions justify-end">
                            <button className="inline-flex items-center font-semibold px-6 py-2 bg-primary hover:bg-orange-600 text-white text-lg  cursor-pointer mt-7">Favorite</button>
                        </div>
